...
description: "Learn how to open a DRM device, allocate a GPU buffer with gbm.rs, write pixel data to it, and display it on screen using DRM/KMS in five steps."
---
