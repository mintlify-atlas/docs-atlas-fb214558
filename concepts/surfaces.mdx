---
title: "GBM Surfaces for EGL Rendering Pipelines"
sidebarTitle: "Surfaces"
description: "Surface<T> provides an EGL-compatible rendering target backed by GBM. Understand the front buffer locking protocol and when to use surfaces vs buffer objects."
---
