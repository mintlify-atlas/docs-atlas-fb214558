---
title: "BufferObject<T> - GBM GPU Buffer Handle API Reference"
sidebarTitle: "BufferObject"
description: "BufferObject<T> reference for gbm.rs: inspect dimensions, format, and modifier; map regions for CPU access; export DMA-BUF fds; and attach typed userdata."
---
