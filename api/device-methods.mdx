...
description: "All Device<T> methods in gbm.rs: backend queries, buffer object and surface creation with modifiers, and buffer import from Wayland, EGL, and DMA-BUF."
---
