---
title: "Device<T> - GBM Device Struct and Trait Implementations"
sidebarTitle: "Device"
description: "API reference for Device<T>, the root gbm.rs type. Wraps a DRM file descriptor and owns the gbm_device lifetime for buffer allocation and surface creation."
---
